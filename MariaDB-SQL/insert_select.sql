...
INSERT INTO usuarios (id, nome, email, data_nascimento, endereco) VALUES (1, "Ygor Nocce", "teste@teste.com", "1999-10-05", "Rua Rafael");
...
INSERT INTO reservas (id, id_usuario, id_destino, STATUS, data) VALUES (2, 3, 3, 'confirmada', '2023-07-10');
...
-- Like
SELECT * FROM usuarios WHERE id = 1 AND nome LIKE '%Ygor%';
